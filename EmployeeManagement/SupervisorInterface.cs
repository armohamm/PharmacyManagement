...
namespace PharmacyManagement
{
    public partial class SupervisorInterface : Form
    {
        ...
        private void searchProductBtn_Click(object sender, EventArgs e)
        {
            ...
            if (temp)
            {
                InventoryManagement.MainWindow pUI = new InventoryManagement.MainWindow(User.CurrentUserName, "Supervisor", User.UserShop);
                opened.Add(pUI);
                pUI.Show();
            }
        }

        private void SupervisorInterface_FormClosing(object sender, FormClosingEventArgs e)
        {
            User.LogObj.clearText();
            User.LogObj.Show();
        ...
        {
            System.Diagnostics.Process.Start(@"C:\Users\Dilantha\Desktop\PharmacyManagement\PharmacyManagement\Resources\Supervisor-Help.pdf");
        }
    }
}
